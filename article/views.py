...
def create_article(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print("Image URL this is image url:", content)  # Print the image URL to console
            article.save()
            # Redirect to article list page
            return redirect('article_home')  # Replace with your article list URL name
    else:
        form = ArticleForm()
...
def upload_image(request):
    if request.method == 'POST' and request.FILES.get('image'):
        ...
        print("Image URL this is image url:", uploaded_image)  # Print the image URL to console
